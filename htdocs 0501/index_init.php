...
<body>
  <nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <img src="assets/logofc.png" width="140" height="140" class="d-inline-block align-top" alt="">
    <!-- Bootstrap -->
  </a>
...
<a class="navbar-brand" href="entrada.php">
    <img src="assets/perfil2.png" class="d-inline-block align-top" alt="">
    <!-- Bootstrap -->
  </a>
...
<?php
       ...
       for($i=0; $i<$total; $i++) {
           ...
           <form action='evento_visaoext.php' method='get'>
